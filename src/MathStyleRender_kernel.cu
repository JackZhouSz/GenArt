    ...
    for (int NSamples = MinSamples - 1; NSamples >= 0; NSamples--) {
...
#ifdef ROTATION
        float xo = SampLoc.x + SampOfs.x;
        if (xo > 0.5f) xo -= 1; // Map -0.5..1.5 to -0.5..0.5
        float yo = SampLoc.y + SampOfs.y;
        if (yo > 0.5f) yo -= 1;
#else
        float xo = SampLoc.x;
        float yo = SampLoc.y;
        ...
        grn = 0.647491 + (eLn(eMod(0.4343 * eLn(eSin(-eExp(eExp(eLn(eSin(eExp(eExp(eSin(x * y))))) + (eSin(2.0723 * x) - eTan(x))))) +
                                                (eSin(eExp(eExp(eSin(eSqrt(r))))) + eDiv(eXOr(eMod(-1.99781 * (eMod(ePow(x, 0.725418), eClamp(eSqrt(y)))), ePow(0.156434, eSin(2.02173 * x))), x * y),
                                                                                         eExp(eSin(eExp(eExp(eSin(eExp(eExp(eSin(eSqrt(y))))) - y))))))),
                                   0.987066)) +
                          (eDiv(eXOr(eCube(2.45321 - 33.3313 * r), eMod(-2.07658 * (eMod(ePow(x, 0.884499), eClamp(eSqrt(y)))), 1)), eExp(eSin(eExp(eExp(eSin(2.95912 * x) - y))))) +
                           ePow(x - (eSqr(y) + 0.4343 * eLn(0.114559 - (x + y))), x)));
        blu =
            0.52584 +
            (eLn(eMod(0.4343 * eLn(eSin(-eExp(eExp(eLn(eSin(eExp(eExp(eSin(x * y))))) + (eSin(2 * x) - eTan(x))))) +
                                   (eSin(eExp(eExp(eSin(eSqrt(r))))) + eDiv(eXOr(eMod(-2.16671 * (eMod(ePow(x, 0.787501), eClamp(eSqrt(y)))), ePow(0.178835, eSin(2.02401 * x))), x * y),
                                                                            eExp(eSin(eExp(eExp(eSin(eExp(eExp(eSin(eSqrt(y))))) - y))))))),
                      1)) +
